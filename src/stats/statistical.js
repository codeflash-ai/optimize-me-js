 ...
 * JavaScript equivalents of Python/NumPy/Pandas implementations
 */
 ...
 * @param {number[][]} X - First matrix (rows are vectors)
 ...
 * @param {number[][]} X - Data matrix (rows are samples)
